...
var timer = (0, rxjs_1.interval)(1000).pipe((0, operators_1.tap)(i => console.log(`Input = ${i}`)));
// timer ist hier implizit abonniert
var obs = clicks.pipe((0, operators_1.withLatestFrom)(timer));
obs.subscribe(x => {
    const [evt, num] = x;
