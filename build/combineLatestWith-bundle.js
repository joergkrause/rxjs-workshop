...
// UI
const z1 = document.querySelector("[name='z1']");
const z2 = document.querySelector("[name='z2']");
const out = document.querySelector("output");
// Jede Änderung löst ein Event aus
const num1$ = (0, rxjs_1.fromEvent)(z1, 'input');
const num2$ = (0, rxjs_1.fromEvent)(z2, 'input');
// egal was die letzten Wert gelten
num1$
    .pipe((0, operators_1.combineLatestWith)(num2$))
    .pipe((0, operators_1.map)(([n1, n2]) => Number(n1.target.value) + Number(n2.target.value)))
    .pipe((0, operators_1.tap)(val => console.log(val)))
