...
(0, rxjs_1.fromEvent)(input, "input")
    // Ausgabe
    .pipe((0, operators_1.tap)(i => console.log(` Input value = ${i.target.value} `)))
    ...
    // gib aus
    .pipe((0, operators_1.tap)(i => console.log(` Output: ${i.target.value} `)));
obs.subscribe();
