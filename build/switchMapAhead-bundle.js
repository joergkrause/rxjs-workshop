...
const obs = (0, rxjs_1.fromEvent)(input, "keyup")
    .pipe((0, operators_1.map)(evt => evt.target.value), (0, operators_1.startWith)(''), (0, operators_1.debounceTime)(400))
    .pipe((0, operators_1.distinctUntilChanged)())
    .pipe((0, operators_1.tap)((val) => console.log(`Input ${val}`)))
    // Setze alternativ concatMap ein, um den Unterschied zu sehen
    .pipe((0, operators_1.switchMap)(value => smartSearch(value)))
