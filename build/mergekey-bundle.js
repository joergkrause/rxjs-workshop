...
const obs = (0, rxjs_1.merge)((0, rxjs_1.fromEvent)(btn, "click"), (0, rxjs_1.fromEvent)(input, "keyup").pipe((0, operators_1.filter)((key) => key.key === "Enter")));
